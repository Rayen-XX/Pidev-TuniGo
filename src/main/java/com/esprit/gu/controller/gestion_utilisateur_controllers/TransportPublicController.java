...
public class TransportPublicController implements Initializable {
    ...
    private void navigateToBus() {
        try {
            // Load the bus view
            Parent root = FXMLLoader.load(getClass().getResource("/views/gestion_utilisateur_views/bus.fxml"));
    ...
    @FXML
    private void navigateToMetro() {
        try {
            // Load the metro view
            Parent root = FXMLLoader.load(getClass().getResource("/views/gestion_utilisateur_views/metro.fxml"));
            Stage stage = (Stage) welcomeLabel.getScene().getWindow();
            stage.setScene(new Scene(root));
        } catch (IOException e) {
            e.printStackTrace();
    ...
    @FXML
    private void navigateToTrain() {
        try {
            // Load the train view
            Parent root = FXMLLoader.load(getClass().getResource("/views/gestion_utilisateur_views/train.fxml"));
            Stage stage = (Stage) welcomeLabel.getScene().getWindow();
            stage.setScene(new Scene(root));
        } catch (IOException e) {
            e.printStackTrace();
    ...
    @FXML
    private void retourMoyTransport() {
        try {
            // Return to moyTransport page
