...
public class MoyTransportController implements Initializable {
    ...
    @FXML
    private void navigateToTransportPublic() {
        try {
            // Load the transport public view
    ...
    @FXML
    private void navigateToTransportPrive() {
        try {
            // Load the transport prive view
