...
public class GestionMenuController {
    ...
    public void goToNotification() {
        try {
            // Utiliser un chemin absolu pour charger le fichier FXML
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/GestionMoyTrans/notification.fxml"));
            Parent notificationDialog = loader.load();
            ...
            e.printStackTrace();
            System.err.println("❌ Erreur lors du chargement de la vue notification.fxml.");
        }
    }
