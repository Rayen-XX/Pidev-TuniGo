...
public class NotificationController {
    ...
    // Méthode pour fermer la fenêtre de notification
    @FXML
    ...
    // Méthode pour changer de scène (par exemple pour revenir à l'écran principal)
    private void changerScene(ActionEvent event, String fxmlFile) {
        try {
            FXMLLoader loader = new FXMLLoader(this.getClass().getResource(fxmlFile));
    ...
    // Méthode pour changer la scène à un autre écran
    @FXML
