                ...
                return new ListCell<Scooter>() {
                    ...
                    protected void updateItem(Scooter scooter, boolean empty) {
                        ...
                        if (!empty && scooter != null) {
                            ...
                            ImageView editIcon = loadImage("/Images/update_icon.png");
                            ImageView deleteIcon = loadImage("/Images/delete_icon.png");
                            ImageView viewIcon = loadImage("/Images/detail_icon.png");
