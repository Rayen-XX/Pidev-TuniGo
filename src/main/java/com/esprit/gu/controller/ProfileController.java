...
public class ProfileController implements Initializable {
    ...
    @FXML
    private Button choisirtaxibutton;

    @FXML
    private Button choisirscooterbutton;
    ...
    @FXML
    private void reserverTaxi() {
        try {
            // Load the admin_dashboard_gu.fxml file
            Parent root = FXMLLoader.load(getClass().getResource("/views/TaxiCoteClient.fxml"));
            Stage stage = (Stage) choisirtaxibutton.getScene().getWindow();
            stage.setScene(new Scene(root));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    @FXML
    private void reserverScooter() {
        try {
            // Load the admin_dashboard_gu.fxml file
            Parent root = FXMLLoader.load(getClass().getResource("/views/ScooterCoteClient.fxml"));
            Stage stage = (Stage) choisirscooterbutton.getScene().getWindow();
            stage.setScene(new Scene(root));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void locationbutton() {
        try {
            // Load the admin_dashboard_gu.fxml file
            Parent root = FXMLLoader.load(getClass().getResource("/views/GeocodingView.fxml"));
            Stage stage = (Stage) locationbutton.getScene().getWindow();
            stage.setScene(new Scene(root));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    private void mapbutton() {
        try {
            // Load the admin_dashboard_gu.fxml file
            Parent root = FXMLLoader.load(getClass().getResource("/views/MapView.fxml"));
